...
def create_problem_optimizer_map(typeofelements):
    t = typeofelements    
    return {\
    TRProblem: {get_method_TR_svc: deepcopy(t), get_method_TR_repair: deepcopy(t)}}
...
optimizers = {\
    TRProblem: [get_method_TR_svc, get_method_TR_repair]
}
...
best_tr2 = best_fitness[TRProblem][get_method_TR_svc]
log_best_tr2 = map(logit, best_tr2, [optimum_fitness] * len(best_tr2))
best_tr2_svc = best_fitness[TRProblem][get_method_TR_repair]
...
pp = PdfPages("dses_dsessvc_repair_hist.pdf")
