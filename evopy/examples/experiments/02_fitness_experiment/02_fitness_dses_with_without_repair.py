...
def create_problem_optimizer_map(typeofelements):
    t = typeofelements    
    return {\
    TRProblem: {get_method_TR: deepcopy(t), get_method_TR_rep: deepcopy(t)},
    SchwefelsProblem26: {get_method_Schwefel26: deepcopy(t), get_method_Schwefel26_rep: deepcopy(t)}}
...
optimizers = {\
    TRProblem: [get_method_TR, get_method_TR_rep],
    SchwefelsProblem26: [get_method_Schwefel26, get_method_Schwefel26_rep]
}
...
zTR, pTR = wilcoxon(\
    ...
    best_fitness[TRProblem][get_method_TR_rep])

zs26, ps26 = wilcoxon(\
    best_fitness[SchwefelsProblem26][get_method_Schwefel26], 
    best_fitness[SchwefelsProblem26][get_method_Schwefel26_rep])

results = file("fitness_with_without_each_results_repair.tex","w")
lines = [
    "\\begin{tabularx}{\\textwidth}{l X X X X X}\n", 
    "\\toprule\n", 
    "\\textbf{Problem} & Reperatur & Minimum & Mittel & Maximum & Varianz \\\\\n",
    "\midrule\n",
    ...
    "& ja & $%0.10f$ & $%0.10f$ & $%0.10f$ & %1.2e \\\\\n"\
        % (variables['min'][TRProblem][get_method_TR_rep],\
        variables['mean'][TRProblem][get_method_TR_rep],\
        variables['max'][TRProblem][get_method_TR_rep],\
        variables['var'][TRProblem][get_method_TR_rep]),\
    ...
    "& ja & $%0.10f$ & $%0.10f$ & $%0.10f$ & %1.2e \\\\\n"\
        % (variables['min'][SchwefelsProblem26][get_method_Schwefel26_rep],\
        variables['mean'][SchwefelsProblem26][get_method_Schwefel26_rep],\
        variables['max'][SchwefelsProblem26][get_method_Schwefel26_rep],\
        variables['var'][SchwefelsProblem26][get_method_Schwefel26_rep]),\
    "\\bottomrule\n", 
    "\end{tabularx}\n"]
