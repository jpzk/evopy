...
class CMAES11Meta(object):
    ...
    def _init_cma_strategy_parameters(self, xstart, sigma):
        ...
        self._feasible_checkpoint = None
        self._infeasible_checkpoint = None
        self.pf = 1.0
        self._last_evals = deque(maxlen=50)
    ...
    def tell_feasibility(self, feasibility_information, use_cf):
