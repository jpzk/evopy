...
errorbar(generations_with_s, accuracies_with_s, label="mit Skalierung", yerr=errors_with_s, color="green")
errorbar(generations_without_s, accuracies_without_s, label="ohne Skalierung", yerr=errors_without_s, color="blue")
