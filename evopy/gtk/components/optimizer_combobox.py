...
class OptimizerComboBox(ComboBox):
    def __init__(self):
        super(OptimizerComboBox, self).__init__()
        ...
        self.append_text("Covariance Matrix Adaption Evolution Strategy (CMA-ES)")
        self.append_text("Death Penalty Step Control Evolution Strategy (DS-ES)")
        self.set_active(0)
