...
class MetamodelComboBox(ComboBox):
    def __init__(self):
        super(MetamodelComboBox, self).__init__()
        ...
        self.append_text("Support Vector Classification (SVC)")
        self.append_text("Support Vector Regression (SVR)")
        self.set_active(0)
