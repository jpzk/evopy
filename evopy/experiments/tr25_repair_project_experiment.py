...
class Experiment():
    ...
    def __init__(self):
        ...
        self._file_fitnesses = 'evopy_experiments/tr25-repair-project/experiment_fitnesses.csv'
        self._file_acc = 'evopy_experiments/tr25-repair-project/experiment_acc.csv'
