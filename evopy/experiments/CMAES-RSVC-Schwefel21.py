...
simulators = []
for i in range(0, 50):
    simulator1 = ExperimentSimulator(get_cmaes_rsvc_method(), SchwefelsProblem12(), 10**-12)
    simulator2 = ExperimentSimulator(get_cmaes_method(), SchwefelsProblem12(), 10**-12)
    simulators.append(simulator1)
    simulators.append(simulator2)

writer = CSVWriter("CMAES-RSVC-Schwefel21")
